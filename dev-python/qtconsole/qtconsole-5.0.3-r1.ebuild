...
src_install() {
	...
	do
		newicon --size "${PNG}" "${FILESDIR}/JupyterConsole.${PNG}.png" "JupyterConsole.png"
	done
	doicon --size scalable "${S}/${PN}/resources/icon/JupyterConsole.svg"
	domenu "${FILESDIR}/jupyter-${PN}.desktop"
}
