...
EGIT_REPO_URI="https://github.com/linuxmint/cinnamon-control-center.git"
...
"
src_configure() {
	meson_src_configure $(meson_use colord color) $(meson_use modemmanager) $(meson_use networkmanager) $(meson_use input_devices_wacom wacom)
}
