...
SRC_URI="http://lftp.yar.ru/ftp/lftp-4.9.2.tar.bz2 -> ${PF}.tar.bz2"
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-4.9.2-libdir-readline.patch"
	"${FILESDIR}/${PN}-4.9.2-autotools-version.patch"
)
