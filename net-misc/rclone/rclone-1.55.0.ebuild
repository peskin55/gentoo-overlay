...
EGO_SUM=(
	...
	"cloud.google.com/go v0.76.0/go.mod"
  ...
  "dmitri.shuralyov.com/gpu/mtl v0.0.0-20190408044501-666a987793e9/go.mod"
	...
	"github.com/anacrolix/dms v1.2.0/go.mod"
	...
	"github.com/btcsuite/btcutil v1.0.3-0.20201124182144-4031bdc69ded/go.mod"
	...
	"github.com/dropbox/dropbox-sdk-go-unofficial v1.0.1-0.20210114204226-41fdcdae8a53/go.mod"
	...
	"github.com/iguanesolutions/go-systemd/v5 v5.0.0/go.mod"
	...
	"github.com/jlaffaye/ftp v0.0.0-20210302195756-c3c8c7ac6590/go.mod"
	...
	"github.com/nsf/termbox-go v0.0.0-20210114135735-d04385b850e8/go.mod"
	...
	"golang.org/x/oauth2 v0.0.0-20210201163806-010130855d6c/go.mod"
	...
	"golang.org/x/sys v0.0.0-20210313110737-8e9fff1a3a18/go.mod"
	...
	"google.golang.org/genproto v0.0.0-20210202153253-cf70463f6119/go.mod"
  ...
  "storj.io/common v0.0.0-20201207172416-78f4e59925c3/go.mod"
  "storj.io/common v0.0.0-20210203145648-3768017a858e"
  "storj.io/common v0.0.0-20210203145648-3768017a858e/go.mod"
  "storj.io/drpc v0.0.16"
  "storj.io/drpc v0.0.16/go.mod"
  "storj.io/uplink v1.4.5"
  "storj.io/uplink v1.4.5/go.mod"
)
...
src_install() {
	dobin "${PN}"
	doman "${S}/${EGO_PN}/${PN}.1"
	dodoc "${S}/${EGO_PN}/README.md"

	"${S}/rclone" genautocomplete bash "${PN}.bash" || die
	newbashcomp "${S}/${PN}.bash" "${PN}"

	"${S}/rclone" genautocomplete zsh "${PN}.zsh" || die
