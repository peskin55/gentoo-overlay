...
EGO_SUM=(
	...
	"github.com/jlaffaye/ftp v0.0.0-20210307004419-5d4190119067/go.mod"
	...
	"github.com/nsf/termbox-go v1.1.1-0.20210421210813-2ff630277754/go.mod"
	...
	"github.com/pkg/sftp v1.13.1-0.20210424083437-2b80967078b8/go.mod"
	...
	"github.com/spacemonkeygo/monkit/v3 v3.0.11"
	"github.com/spacemonkeygo/monkit/v3 v3.0.11/go.mod"
	...
	"storj.io/common v0.0.0-20210419115916-eabb53ea1332/go.mod"
...
src_install() {
	...
	"${S}/rclone" genautocomplete bash "${S}/${PN}.bash" || die
	newbashcomp "${S}/${PN}.bash" "${PN}"

	"${S}/rclone" genautocomplete zsh "${S}/${PN}.zsh" || die
	insinto "/usr/share/zsh/site-functions"
	newins "${S}/${PN}.zsh" "_${PN}"
	
	"${S}/rclone" genautocomplete fish "${S}/${PN}.fish" || die
