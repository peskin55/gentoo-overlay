...
src_install() {
	...
	do
		newicon --size "${ICON}" "${D}/opt/Wolfram/Mathematica/${PV%.*}/SystemFiles/FrontEnd/SystemResources/X/App-${ICON}.png" "wolfram-${PN}.png"
	done
	# install mime types
	...
	find "${D}/opt/Wolfram/Mathematica/${PV%.*}/Executables" -type l -delete
	dosym ../"SystemFiles/Kernel/Binaries/Linux-x86-64/wolframscript" "/opt/Wolfram/Mathematica/${PV%.*}/Executables/wolframscript"
}
