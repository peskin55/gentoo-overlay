...
PATCHES=(
	"${FILESDIR}/patches_old/${PN}-1.3.959-prefs.patch"
	"${FILESDIR}/patches_old/${PN}-1.3.959-paths.patch"
	"${FILESDIR}/patches_old/${PN}-1.3.959-pandoc-mathjax.patch"
	"${FILESDIR}/patches_old/${PN}-1.2.1335-linker_flags.patch"
	"${FILESDIR}/patches_old/${PN}-1.3.959-qtsingleapplication.patch"
	"${FILESDIR}/patches_old/${PN}-1.0.44-systemd.patch"
	"${FILESDIR}/patches_old/${PN}-1.3.959-core.patch"
	"${FILESDIR}/patches_old/${PN}-1.2.5042-boost-1.73.0.patch"
	"${FILESDIR}/patches_old/${PN}-1.3.1056-R-4.0.0.patch"
	"${FILESDIR}/patches_old/${PN}-1.3.1056-boost-1.74.0.patch"
)
